...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'view_ordcs', t_bbsTag = 'tbbs', t_content = " field=productno,product,unit,mount,price,total,memo,notv,noa,no2,engno,engono,engono2  order=odate ", afilter = [], bbsKey = ['noa', 'no2'], t_count = 0, as;
            var t_sqlname = 'view_ordcs_load';
            t_postname = q_name;
            //brwCount2 = 12;
            var isBott = false;
            /// 是否已按過 最後一頁
		...
		<div id='dbbs' class='dbbs'>
            <table id="tbbs" class='tbbs'>
                <tr style='color:white; background:#003366;' >
					...
					<td align="center" style="width:110px;"><a id='lblEngno'> </a></td>
					...
					<td align="center" style="width:80px;"><a id='lblTotal'> </a></td>
				...
				<tr  style='background:#cad3ff;'>
					...
					<td><input class="txt"  id="txtEngno.*" type="text" style="width:95%;" /></td>
