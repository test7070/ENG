...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr">
	<head>
		...
		<script type="text/javascript">
            ...
            brwCount2 = 10;
            aPop = new Array(
            	['txtTggno', 'lblTgg', 'tgg', 'noa,comp', '0txtTggno,txtComp', 'tgg_b.aspx']
            	,['txtEngno', 'lblEng', 'eng', 'noa,eng', '0txtEngno,txtEng', 'eng_b.aspx']
            	);
            ...
            function mainPost() {
				...
				$('#btnEngpw').click(function() {
					if(!emp($('#txtNoa').val())){
						var t_where = "noa='" + $('#txtNoa').val() + "'";
						q_box("engpw.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";" + t_where, 'engpw', "95%", "650px", q_getMsg('btnEngpw'));
					}
				});
                	...
                	case 'engpw':
		                setTimeout(function () {
					        if($('#txtNoa').val().length != 0 && $('#txtNoa').val() != "AUTO"){
								q_func('qtxt.query.engpnochange', 'engo.txt,engpno_change,' + encodeURI($('#txtNoa').val()));
							}
					    }, 1500);
                		break;
                    case q_name + '_s':
            ...
            function btnOk() {
                ...
                if (t_noa.length == 0 || t_noa == "AUTO")
                    q_gtnoa(q_name, replaceAll(q_getPara('sys.key_engp') + (t_date.length == 0 ? q_date() : t_date), '/', ''));
                else
                    wrServer(t_noa);
            }
                ...
                for (var j = 0; j < q_bbsCount; j++) {
                    ...
                    if (!$('#btnMinus_' + j).hasClass('isAssign')) {
                        ...
                        $('#btnRecord_'+j).click(function() {
							...
							b_seq = t_IdSeq;
							q_box("engps_b.aspx?"+ r_userno + ";" + r_name + ";" + q_id + ";charindex('"+$('#txtProduct_'+b_seq).val()+"',product)>0;"+r_accy,'engps', "90%", "600px", $('#btnRecord_'+b_seq).val());
						});
                    }
                }
                _bbsAssign();
            ...
            function btnPrint() {
                q_box("z_engpp.aspx?" + r_userno + ";" + r_name + ";" + q_time + ";engno='" + $('#txtEngno').val()+ "';" + r_accy + "_" + r_cno, 'engpp', "95%", "95%", m_print);
            }
				...
				<table class="tbbm"  id="tbbm">
					...
					<tr>
						...
						<td align="center" colspan="2">
							...
							<input id="btnEngpw" type="button" style="float: none;"/>
			...
			<div class='dbbs' >
				<table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
					...
					<tr  style='background:#cad3ff;'>
						...
						<td ><select id="cmbChase.*" class="txt c1"> </select></td>
