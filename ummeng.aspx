	...
	<head>
		...
		<script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                bbsKey = ['noa', 'noq'];
                q_brwCount();
                q_gt('acomp','', 0, 0, 0, JSON.stringify({action:'acomp'}));
            });
            function main() {
                mainForm(1);
            }
            ...
            function mainPost() {
		        ...
		        $('#txtDatea').blur(function() {
		         	if(q_cd($('#txtDatea').val()) && $('#txtDatea').val().length>0 && $('#txtMon').val().length==0 &&(q_cur==1 || q_cur==2))
                    ...
                    default:
                    	...
                    	try{
                    		...
                    		if(t_para.action=="acomp"){
			                	...
			                	q_gt('part', '', 0, 0, 0, JSON.stringify({action:'part'}));
							}else if(t_para.action=="part"){
