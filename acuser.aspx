...
<!--#include file="../inc/toolbar.inc"-->
       ...
       <table id="tbbs" class='tbbs'  border="1"  cellpadding='2' cellspacing='1'  >
            ...
            <tr  style='background:#cad3ff;'>
              ...
              <td style="width:7%;"> <input class="btn"  id="btnPart.*" type="button" value='.' style=" font-weight: bold; " />
              <input class="txt" id="txtPart.*" type="text" maxlength='90' style="width:55%; " /></td>
              <td style="width:13%;"><input class="btn"  id="btnAcc.*" type="button" value='.' style=" font-weight: bold;" />
              <input class="txt" id="txtAccc5.*" type="text" maxlength='90' style="width:75%;" /></td>
                <td style="width:20%;"><input class="txt" id="txtAccc6.*" type="text" maxlength='10' style="width:97%;"/></td>
                <td style="width:25%;"> <input class="btn"  id="btnQphr.*" type="button" value='.'  />
                                       <input class="txt" id="txtAccc7.*" type="text" maxlength='20' style="width:85%;"/></td>
                <td style="width:8%;"><input class="txt" id="txtDmoney.*" type="text" maxlength='20' style="width:97%; text-align:right;"/><input id="recno.*" type="hidden" /></td>
                <td style="width:8%;"><input class="txt" id="txtCmoney.*" type="text" maxlength='20' style="width:97%; text-align:right;"/><input id="Hidden1" type="hidden" /></td>
            </tr>
        </table>
        </div>
        </div>
