	...
	<head>
		...
		<script type="text/javascript">
            ...
            function q_seekStr() {///  搜尋按下時，執行
                ...
                var t_where = " 1=1 " + q_sqlPara2("noa", t_noa) + q_sqlPara2("cno", t_cno) + q_sqlPara2("datea", t_bdate, t_edate) + q_sqlPara2("mon", t_mon) + q_sqlPara2("tggno", t_tggno) + q_sqlPara2("invono", t_invono);
