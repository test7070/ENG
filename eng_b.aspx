...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
            var q_name = 'eng', t_content = ' field=noa,eng,nick,cust,comp,strdate,enddate', bbsKey = ['noa'], as;
            var isBott = false;
            /// 是否已按過 最後一頁
		...
		<div  id="dbbs"  >
			<table id="tbbs"  border="2"  cellpadding='0' cellspacing='0' style='width:98%' >
				...
				<tr>
					...
					<td style="width:60%;"><input class="txt" id="txteng.*" type="text" style="width:98%;"  readonly="readonly" /></td>
				</tr>
			</table>
